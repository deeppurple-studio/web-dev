...
*Могут находится не только в ветвлениях и циклах, можно также записать и в переменную (оно тут же вычислится и результат будет записан в переменную)*
...
} catch (тип_перехватываемой_ошибки) {
