...
4. [Циклы](#Циклы)
5. [Функции](#Функции)
6. [Перехват ошибок](#Перехват-ошибок)
...
Можно вызывать функцию внутри себя, что называется **рекурсией**. Рекурсия ограничена по количеству вызовов (количество этих вызовов - *глубина рекурсии*). [Подробнее про рекурсию](https://learn.javascript.ru/recursion).
